...
Para ayudar a esto, vamos a crear una función que pasándole una instancia de Date nos diga el número de días
 que faltan.
...
function dyas(date) {
    ...
    const timeToXmas = (dateXmas - date)/(8.64*10**7);

    return Math.ceil(timeToXmas);
};
